...
Item *
Create_func_priv_user::create_native(THD *thd, LEX_CSTRING *name, List<Item> *item_list)
{
  return new (thd->mem_root) Item_func_priv_user(thd);
}
...
static Native_func_registry func_array[] =
{
  ...
  { { STRING_WITH_LEN("PRIV_USER") }, BUILDER(Create_func_priv_user)},
